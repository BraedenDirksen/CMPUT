...
def main():
    ...
    try:
        ...
        plot2(queues_sizes, bounded_queue_times , circular_queue_times, len(queues_sizes), len(bounded_queue_times))
    ...
    try:
        ...
        plot2(queues_sizes, avg_b_queue_times, avg_c_queue_times, len(queues_sizes), len(avg_b_queue_times))
    except:
        print("Not able to print graph. Continuing .....")
